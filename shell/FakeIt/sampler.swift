...
public func loadAudioFile(_ forResource: String) -> AVAudioFile? {
    let url = URL(fileURLWithPath: "/Users/noahbkim/Repositories/noahbkim/fakeit/FakeIt/FakeIt/Samples/\(forResource)")
    do {
